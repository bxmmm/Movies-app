...
const API_KEY = '280bb06ec7511a5afe194e0e3f47bbb6';
...
export function top10Movies () {
	const URL = 'https://api.themoviedb.org/3/movie/top_rated?api_key=280bb06ec7511a5afe194e0e3f47bbb6';
...
export function top10Series () {
	const URL = 'https://api.themoviedb.org/3/tv/top_rated?api_key=280bb06ec7511a5afe194e0e3f47bbb6&page=1';
...
export function searchSeries (searchTerm) {
	const URL = `https://api.themoviedb.org/3/search/tv?api_key=280bb06ec7511a5afe194e0e3f47bbb6&page=1&query=${searchTerm}`;
...
export function findMovieById(id){
	const URL = `https://api.themoviedb.org/3/movie/${id}?api_key=280bb06ec7511a5afe194e0e3f47bbb6`;
...
export function findSerieById(id) {
	const URL = `https://api.themoviedb.org/3/tv/${id}?api_key=280bb06ec7511a5afe194e0e3f47bbb6`;
